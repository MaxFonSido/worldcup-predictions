...
const en = {
  ...
  championLockNote: "You can change your pick anytime while picking is open.",
  championLocked: "Champion picking is closed right now.",
  championReopenNote: "Picks are open again for a limited time — lock in your champion!",
  championBannerText: "Champion picking is open — go lock in your pick!",
  ...
  moreTab: "More",
  accountTab: "Account",
  briefTab: "Morning Brief",
  accountTitle: "My Account",
  accountEmoji: "Choose Your Emoji",
  accountEmojiSub: "Pick an emoji that shows next to your name.",
  accountEmojiSaved: "Saved!",
  accountEmail: "Email Notifications",
  accountEmailSub: "Get daily match schedules and reminders before each game.",
  accountSubscribed: "Subscribed",
  accountNotSubscribed: "Not subscribed",
...
const fa: Dict = {
  ...
  championLockNote: "تا وقتی پیش‌بینی قهرمان بازه، می‌تونی انتخابت رو عوض کنی.",
  championLocked: "پیش‌بینی قهرمان فعلاً بسته‌ست.",
  championReopenNote: "پیش‌بینی برای مدت محدودی دوباره باز شده — قهرمانت رو ثبت کن!",
  championBannerText: "پیش‌بینی قهرمان باز شده — انتخابت رو ثبت کن!",
  ...
  moreTab: "بیشتر",
  accountTab: "حساب",
  briefTab: "خلاصه صبحگاهی",
  accountTitle: "حساب من",
  accountEmoji: "ایموجی خود را انتخاب کنید",
  accountEmojiSub: "ایموجی‌ای انتخاب کنید که کنار اسمتان نمایش داده شود.",
  accountEmojiSaved: "ذخیره شد!",
  accountEmail: "اعلان‌های ایمیلی",
  accountEmailSub: "برنامه بازی‌های روزانه و یادآوری قبل از هر بازی دریافت کنید.",
  accountSubscribed: "عضو شده‌اید",
  accountNotSubscribed: "عضو نشده‌اید",
  standingsTab: "جدول",
